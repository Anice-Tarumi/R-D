    ...
    <RigidBody colliders={false} lockRotations ref={rb} friction={1} userData={{ type: "Player" }}>
      ...
      <BallCollider
        ...
        onIntersectionEnter={(event) => {
          ...
          if (type) {
            if(type === "NPC")
            // useInteractionStore.setCurrentTarget({ type, id, ref,isClose });
            // setTarget({type, id, ref, isClose})
            useInteractionStore.setState({ currentTarget: { type, id, ref,isClose } });
        ...
        // onIntersectionEnter={(event) => {
        //   console.log("userData:", event.target.rigidBodyObject.parent.children[6].children[0].userData);
        //   console.log("Full Event Object:", event);
        // }}
        // onIntersectionEnter={(event) => {
        //   console.log("event.other.userData:", event.other.userData);
        //   const userData = event.other.userData || {};

        //   if (userData.type === "NPC") {
        //     console.log(`Player is near NPC: ${userData.id}`);
        //   } else if (userData.type === "Chest") {
        //     console.log(`Player is near the chest: ${userData.id}`);
        //   } else {
